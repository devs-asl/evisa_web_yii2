    ...
    <div class="row">
        <div class="col-xl-4">
            ...
            <div class="form-group fv-plugins-icon-container has-danger">
                ...
                <input type="text" class="form-control form-control-solid form-control-lg" name="gname" placeholder="Given Name" value="dsad">
        ...
        <div class="col-xl-4">
            ...
            <div class="form-group fv-plugins-icon-container has-danger">
                ...
                <input type="text" class="form-control form-control-solid form-control-lg" name="sname" placeholder="Sur Name" value="dasd">
        ...
        <div class="col-xl-4">
            ...
            <div class="form-group fv-plugins-icon-container has-danger">
                ...
                <input type="text" class="form-control form-control-solid form-control-lg" name="mname" placeholder="Middle Name" value="dasda">
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            ...
            <div class="form-group fv-plugins-icon-container has-success">
                ...
                <input type="number" class="form-control form-control-solid form-control-lg" name="nid" placeholder="National ID" value="12312">
        ...
        <div class="col-xl-6">
            ...
            <div class="form-group fv-plugins-icon-container has-success">
                ...
                <select class="form-control form-control-solid form-control-lg" name="mstatus" id="formControl2">
                    ...
                    <option value="unmarried" selected>Un-Married</option>
                </select>
                <span class="form-text text-muted">Please enter your Gender.</span>
                <div class="fv-plugins-message-container"></div>
            </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            ...
            <div class="form-group fv-plugins-icon-container has-danger">
                ...
                <input type="number" class="form-control form-control-solid form-control-lg" name="passport_number" placeholder="Passport Number" value="232434242">
        ...
        <div class="col-xl-6">
            ...
            <div class="form-group fv-plugins-icon-container has-danger">
                ...
                <select class="form-control form-control-solid form-control-lg" name="passport_type" id="passport_type">
                    <option value>Select</option>
                    <option value="typeA" selected>Type A</option>
