...
<!--                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="nid" placeholder="National ID" value="">-->
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group fv-plugins-icon-container has-danger">
                                                        ...
                                                        <select name="poi" class="form-control form-control-solid form-control-lg">
                                                            <option value="">Select</option>
                                                        ...
                                                        <span class="form-text text-muted">Please enter passport issue place.</span>
                                                        <div class="fv-plugins-message-container"></div>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content">
                                            <h4 class="mb-10 font-weight-bold text-dark">Setup Your Contact Details</h4>
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <!--begin::Input-->
                                                    <div class="form-group fv-plugins-icon-container">
                                                        <label>Mailing Address</label>
                                                        <input type="email" class="form-control form-control-solid form-control-lg" name="mail_address" placeholder="address line 1" value="address line 1">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group fv-plugins-icon-container">
                                                        ...
                                                        <input type="number" class="form-control form-control-solid form-control-lg" name="postcode" placeholder="State" value="3000">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group fv-plugins-icon-container">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="em_contact_name" placeholder="State" value="3000">
                                                        <span class="form-text text-muted">Please enter your Emergency Contact Name.</span>
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="em_address" class="form-control form-control-solid form-control-lg" name="em_address" placeholder="example" value="Address Line 1">
                                                <span class="form-text text-muted">Please enter your Emergency Address.</span>
                                                <div class="fv-plugins-message-container"></div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group fv-plugins-icon-container">
                                                        ...
                                                        <input type="em_mobile_number" class="form-control form-control-solid form-control-lg" name="em_mobile_number" placeholder="example" value="903182030">
                                                        <span class="form-text text-muted">Please enter your Emergency Mobile Number.</span>
                                                        <div class="fv-plugins-message-container"></div>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group fv-plugins-icon-container">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid form-control-lg" name="em_relation" placeholder="" value="example">
                                                        <span class="form-text text-muted">Please enter your Relation with this contact.</span>
                                                        <div class="fv-plugins-message-container"></div>
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
