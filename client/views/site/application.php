                                    ...
                                    <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form">
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                            ...
                                            <div class="form-group fv-plugins-icon-container has-danger">
                                                ...
                                                <div class="fv-plugins-message-container"><div data-field="fname" data-validator="notEmpty" class="fv-help-block">First name is required</div></div></div>
                                            <!--end::Input-->
                                            ...
                                            <div class="form-group fv-plugins-icon-container has-danger">
                                                ...
                                                <div class="fv-plugins-message-container"><div data-field="lname" data-validator="notEmpty" class="fv-help-block">Last Name is required</div></div></div>
                                            <!--end::Input-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="form-group fv-plugins-icon-container has-success">
                                                        <label>Email</label>
                                                        <input type="email" class="form-control form-control-solid form-control-lg is-valid" name="email" placeholder="Email" value="john.wick@reeves.com">
